...
df = pd.read_csv('../../AppData/Roaming/JetBrains/PyCharm2023.3/scratches/daily_discussion_links.csv')
...
for index, link in enumerate(links, start=0):
    ...
    with open(f"../../AppData/Roaming/JetBrains/PyCharm2023.3/scratches/reddit_comments_{df.iat[index, 0]}.csv", "w", newline="", encoding="utf-8") as csv_file:
